...
g++ -std=c++11 -fopenmp -I./gtest/include -L./gtest/lib src/unitTests/DataProcessor_test.cpp obj/DataProcessor.o obj/Event.o -o DataProcessorTest.out -lgtest -lgtest_main -lpthread -fopenmp
